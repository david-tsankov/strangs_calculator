...
def solve_system_of_equations(self: "Matrix_Manager", other: "Vector_Manager",name_solution: str="Solution"):
    ...
    if np.linalg.det(self.components)!=0:
        ...
        solution_object=Vector_Manager(x,name_solution)
        Vector_Manager.object_saver(solution_object)
